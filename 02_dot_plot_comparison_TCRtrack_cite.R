...
intgr_for_tcrtrack <- subset(intgr_for_tcrtrack, cells = sample(1:length(rownames(intgr_for_tcrtrack[[]])), 20000))
...
wrap_plots(list(dot_plot_tcrtrack, dot_plot_citeseq)) + plot_layout(nrow = 1, heights = c(1, 1))
